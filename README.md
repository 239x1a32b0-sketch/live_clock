...
- **Dual Clock Display**: 
  ...
  - **Digital Clock**: Clear 12-hour format display with AM/PM indicators and full date.
- **Precision Timing**: 
  - Uses the `Intl.DateTimeFormat` API to strictly enforce 'Asia/Kolkata' timezone, ensuring accuracy regardless of the user's system timezone.
- **Modern Aesthetics**:
  - **Glassmorphism**: Translucent, frosted-glass effects for clock cards.
  - **Dynamic Background**: Animated gradient background with floating, glowing elements.
